 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rt="storage";function qs(t,e,n){return t=le(t),$s(t,e,n)}function Ws(t){return t=le(t),Bs(t)}function Xs(t){return t=le(t),Ms(t)}function it(t,e){return t=le(t),Vs(t,e)}function lt(t=gt(),e){t=le(t);const s=ft(t,rt).getImmediate({identifier:e}),r=mt("storage");return r&&Ys(s,...r),s}function Ys(t,e,n,s={}){zs(t,e,n,s)}function Ks(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),s=t.getProvider("auth-internal"),r=t.getProvider("app-check-internal");return new Ae(n,s,r,e,bt)}function Gs(){pt(new _t(rt,Ks,"PUBLIC").setMultipleInstances(!0)),De(Se,$e,""),De(Se,$e,"esm2017")}Gs();const Qs={components:{Icon:ae},setup(){const t=g(""),e=g(""),n=g(""),s=g([]),r=g(!1),a=g(""),l=g([]),c=g(!1),i=g(!1),d=g(null),y=ue(),x=g(y.currentUser),R=xe(),U=lt(),v=Re(R,"recipe");return Ne(n,p=>{r.value=p.trim()!==""}),Ne(a,p=>{c.value=p.trim()!==""}),{title:t,descriptions:e,post:async()=>{const{uid:p,displayName:m,photoURL:D}=x.value;let $="";const K=new Date;if(d.value){const W=it(U,`images/${d.value.name}`),_=await qs(W,d.value);$=await Ws(_.ref)}const se={userId:p,userName:m,userPhotoURL:D,title:t.value,descriptions:e.value,allIngredients:s.value,allInstructions:l.value,createdAt:K,imageURL:$,totalRatings:0};try{i.value=!0,await Rt(v,se),t.value="",e.value="",s.value="",l.value="",a.value="",n.value="",d.value=null,document.getElementById("my_modal_3").close(),console.log("success!")}catch(W){console.error("Error sending post recipe:",W)}finally{i.value=!1}},ingredients:n,instructions:a,allInstructions:l,canAddIntructions:c,addIngredients:()=>{s.value.push(n.value),n.value="",console.log(s.value)},addInstructions:()=>{l.value.push(a.value),a.value="",console.log(l.value)},allIngredients:s,removeIngredients:p=>{s.value.pop(p)},removeIstructions:p=>{l.value.pop(p)},canAddIngredient:r,loading:i,handleImageUpload:p=>{d.value=p.target.files[0]}}}},Js={class:"btn mt-5 btn-primary rounded-full",onclick:"my_modal_3.showModal()"},Zs={class:""},en={id:"my_modal_3",class:"modal"},tn={class:"modal-box"},sn=o("form",{method:"dialog"},[o("button",{class:"btn btn-sm btn-circle btn-ghost absolute right-2 top-2"}," ✕ ")],-1),nn=o("h3",{class:"font-bold text-lg"},"Add your recipe.",-1),on={class:"py-3 grid grid-cols-1 gap-2"},rn={class:"input input-bordered flex items-center gap-2"},ln=o("span",{class:"text-xs sm:text-base"},"Title:",-1),an={class:"input input-bordered flex items-center gap-2"},cn=o("span",{class:"text-xs sm:text-base"},"Descriptions:",-1),dn={class:"input input-bordered pr-0 flex items-center gap-2"},un=o("span",{class:"text-xs sm:text-base"},"Ingredients:",-1),hn=["disabled"],pn={key:0},_n={class:"grid grid-cols-1 gap-1"},fn={class:"flex justify-between items-center px-2 py-1 bg-blue-400/10 border shadow border-gray-500/10 rounded-md"},mn={class:"text-sm font-medium"},gn=["onClick"],bn={class:"input input-bordered pr-0 flex items-center gap-2"},yn=o("span",{class:"text-xs sm:text-base"},"Instructions:",-1),xn=["disabled"],Rn={key:1},vn={class:"grid grid-cols-1 gap-1"},wn={class:"flex justify-between items-center px-2 py-1 bg-blue-400/10 border shadow border-gray-500/10 rounded-md"},kn={class:"text-sm font-medium"},In=["onClick"],Tn=o("p",{class:"text-sm font-semibold"},"Add Image:",-1),An={key:0,class:"loading loading-dots loading-xs"};function Un(t,e,n,s,r,a){const l=j("Icon");return u(),h(N,null,[o("button",Js,[b(l,{icon:"ci:add-plus",class:"text-2xl"}),ee("Add Recipes ")]),o("div",Zs,[o("dialog",en,[o("div",tn,[sn,nn,o("form",{onSubmit:e[7]||(e[7]=F((...c)=>s.post&&s.post(...c),["prevent"]))},[o("div",on,[o("label",rn,[ln,z(o("input",{"onUpdate:modelValue":e[0]||(e[0]=c=>s.title=c),required:"",type:"text",class:"grow placeholder:text-xs",placeholder:"Adobo"},null,512),[[q,s.title]])]),o("label",an,[cn,z(o("input",{"onUpdate:modelValue":e[1]||(e[1]=c=>s.descriptions=c),required:"",type:"text",class:"w-full placeholder:text-xs",placeholder:"A classic..."},null,512),[[q,s.descriptions]])]),o("label",dn,[un,z(o("input",{"onUpdate:modelValue":e[2]||(e[2]=c=>s.ingredients=c),type:"text",class:"w-full placeholder:text-xs",placeholder:"Eggs"},null,512),[[q,s.ingredients]]),o("button",{class:re(["btn",s.canAddIngredient?"btn-primary ":"btn-disabled"]),disabled:!s.canAddIngredient,onClick:e[3]||(e[3]=F((...c)=>s.addIngredients&&s.addIngredients(...c),["prevent"]))},[b(l,{icon:"ci:add-plus",class:"text-2xl"})],10,hn)]),s.allIngredients.length!==0?(u(),h("div",pn,[o("div",_n,[(u(!0),h(N,null,L(s.allIngredients,(c,i)=>(u(),h("div",{key:c.id},[o("div",fn,[o("span",mn,f(i+1)+". "+f(c),1),o("button",{class:"",onClick:F(d=>s.removeIngredients(c),["prevent"])},[b(l,{icon:"carbon:close"})],8,gn)])]))),128))])])):O("",!0),o("label",bn,[yn,z(o("input",{type:"text","onUpdate:modelValue":e[4]||(e[4]=c=>s.instructions=c),class:"w-full placeholder:text-xs",placeholder:"Cook spaghetti until..."},null,512),[[q,s.instructions]]),o("button",{class:re(["btn",s.canAddIntructions?"btn-primary":"btn-disabled"]),disabled:!s.canAddIntructions,onClick:e[5]||(e[5]=F((...c)=>s.addInstructions&&s.addInstructions(...c),["prevent"]))},[b(l,{icon:"ci:add-plus",class:"text-2xl"})],10,xn)]),s.allInstructions.length!==0?(u(),h("div",Rn,[o("div",vn,[(u(!0),h(N,null,L(s.allInstructions,(c,i)=>(u(),h("div",{key:c.id},[o("div",wn,[o("span",kn,f(i+1)+". "+f(c),1),o("button",{class:"",onClick:F(d=>s.removeIstructions(c),["prevent"])},[b(l,{icon:"carbon:close"})],8,In)])]))),128))])])):O("",!0),o("div",null,[Tn,o("input",{type:"file",onChange:e[6]||(e[6]=(...c)=>s.handleImageUpload&&s.handleImageUpload(...c)),accept:"image/*",class:"file-input file-input-bordered w-full"},null,32)]),o("button",{class:re(["btn mt-5 w-full",s.loading?"btn-disabled":"btn-primary "]),type:"submit"},[ee(" Post Recipe "),s.loading?(u(),h("span",An)):O("",!0)],2)])],32)])])])],64)}const En=te(Qs,[["render",Un]]),Cn={},Dn={class:"flex flex-col gap-2 w-26"},Nn=o("div",{class:"skeleton h-20 w-full"},null,-1),On=o("div",{class:"skeleton h-2 w-28"},null,-1),Ln=o("div",{class:"skeleton h-2 w-20"},null,-1),Pn=o("div",{class:"skeleton h-2 w-full"},null,-1),Sn=[Nn,On,Ln,Pn];function $n(t,e){return u(),h("div",Dn,Sn)}const at=te(Cn,[["render",$n]]),Bn={props:{searchQuery:{type:String,default:""}},components:{Loading:at,Icon:ae},setup(t){const e=g(!0),n=ue(),s=g(n.currentUser),r=xe(),a=!0,l=g(!1),{uid:c}=s.value,i=c,d=g([]),y=fe(()=>d.value.filter(_=>_.title.toLowerCase().includes(t.searchQuery.toLowerCase()))),x=g({});let R=g(0);const U={1:"Poor",2:"Fair",3:"Good",4:"Very Good",5:"Excellent"},v=fe(()=>U[R.value]||""),B=Re(r,"recipe"),A=Me(B,je("createdAt","asc")),M=Fe(A,_=>{d.value=_.docs.map(w=>({id:w.id,...w.data()})).reverse(),e.value=!1}),S=_=>{const w=_.seconds,X=_.nanoseconds/1e6;return new Date(w*1e3+X)},E=_=>{const w=S(_),X=w.getFullYear().toString().slice(-2),V=w.toLocaleString("default",{month:"short"}),G=w.getUTCDate(),ne=w.getHours()%12||12,pe=("0"+w.getMinutes()).slice(-2),_e=w.getHours()<12?"am":"pm";return`${G} ${V} ${X} (${ne}:${pe} ${_e})`};let T=g(!1);const p=_=>{x.value=_,T.value=se(i),document.getElementById("my_modal_4").showModal()},m=()=>{R.value=0,document.getElementById("my_modal_4").close()};let D=g("");const $=(_,w)=>{D.value=w,R.value=_},K=async(_,w,X)=>{try{l.value=!0;const V=be(r,"recipe",_),G=await He(V);if(G.exists()){const ne=G.data(),pe=ne.totalRatings||0,_e=ne.ratingCount||0,Ue=pe+w,Ee=_e+1,ct=Ue/Ee,Ce=ne.usersIdThatRate||[];Ce.push(X),await Ve(V,{totalRatings:Ue,ratingCount:Ee,averageRating:ct,usersIdThatRate:Ce}),console.log(`Updated recipe ${_} with new ratings and average rating.`)}else console.log("No such recipe document!")}catch(V){console.error("Error updating ratings: ",V)}finally{l.value=!1}},Z=async()=>{const _=R.value,w=D.value;await K(w,_,i),m()},se=_=>(x.value.usersIdThatRate||[]).includes(_),W=fe(()=>{const _=[],w=x.value.averageRating||0,X=Math.floor(w),V=w%1!==0;for(let G=0;G<X;G++)_.push("full");for(V&&_.push("half");_.length<5;)_.push("empty");return _});return Be(()=>{M()}),{loading:e,sendingRatingLoading:l,recipe:d,formatHour:E,isLoading:a,showRecipeAllModal:p,selectedAllRecipe:x,ratings:R,setRating:$,closeModal:m,ratingsInText:v,sendRatings:Z,starArray:W,filteredRecipes:y,muteRateBnt:T}}},Mn={class:"border rounded-md border-gray-400/50 p-2 my-3"},jn=o("h1",{class:"font-semibold py-2 text-blue-500"},"All Recipes",-1),Fn={key:0,class:"w-full"},Hn=o("span",{class:"text-sm px-4 py-1 w-full rounded-full bg-error/10 font-semibold text-error"},"No Recipe found",-1),Vn=[Hn],zn={class:"flex justify-center sm:justify-start items-center"},qn={key:0,class:"grid grid-cols-3 lg:grid-cols-5 gap-2 sm:gap-3 overflow-hidden py-5 px-2 sm:p-2"},Wn=["onClick"],Xn={class:"rounded-full absolute -top-1 -left-1 shadow-xl border border-secondary"},Yn={class:"flex justify-center items-center"},Kn=["src"],Gn={key:1,class:"bg-primary text-neutral shadow rounded-full p-1"},Qn=["src"],Jn={key:1,class:"pt-2"},Zn={class:"px-1 py-2"},eo={class:"card-title"},to={class:"text-xs truncate"},so={class:"sm:text-xs py-0.5 text-[10px] font-medium px-2 rounded-full text-blue-500 truncate bg-blue-500/20"},no={key:0},oo={id:"my_modal_4",class:"modal",ref:"recipeModal"},ro={class:"modal-box"},io={method:"dialog",class:"absolute top-0 right-0 p-2 z-10"},lo={class:"font-bold text-4xl capitalize"},ao=o("span",{class:"text-xs"},"ni",-1),co={class:"text-xs px-2 py-1 rounded-full bg-primary/10 text-primary"},uo={class:"py-2 flex justify-start items-center"},ho={key:1,class:"py-2 flex justify-start items-center"},po={class:"px-2 text-sm"},_o=o("hr",{class:"border border-gray-500/10"},null,-1),fo={class:"py-4"},mo=o("p",{class:"text-xs text-primary"},"Discriptions:",-1),go={class:"capitalize"},bo=o("hr",{class:"border border-gray-500/10"},null,-1),yo={class:"py-4"},xo=o("p",{class:"text-xs text-primary"},"Ingredients:",-1),Ro=o("hr",{class:"border border-gray-500/10"},null,-1),vo={class:"py-4"},wo=o("p",{class:"text-xs text-primary"},"Instructions:",-1),ko=o("hr",{class:"border border-gray-500/10 my-2"},null,-1),Io={key:0},To={class:"text-sm tracking-wide bg-blue-500/10 shadow text-blue-500 px-2 py-1 rounded-full"},Ao={key:1,class:"my-2 flex justify-center items-center"},Uo=o("span",{class:"px-3 py-1 bg-secondary/10 rounded-full font-semibold text-sm"},"You're already rate this recipe.",-1),Eo=[Uo],Co={class:"flex justify-start items-center gap-2"},Do=o("div",{class:"flex gap-1"},[o("span",{class:"text-sm font-semibold"},"RATE:")],-1),No=["disabled","onClick"],Oo=["disabled"],Lo={key:0,class:"loading loading-dots loading-xs"};function Po(t,e,n,s,r,a){const l=j("Icon"),c=j("Loading");return u(),h("div",Mn,[jn,s.filteredRecipes.length===0&&!s.loading?(u(),h("div",Fn,Vn)):O("",!0),o("div",zn,[s.filteredRecipes?(u(),h("div",qn,[(u(!0),h(N,null,L(s.filteredRecipes,i=>(u(),h("div",{key:i.id,onClick:d=>s.showRecipeAllModal(i),class:"card sm:w-52 w-26 bg-base-100 shadow border border-gray-200/10 relative rounded-md"},[o("div",Xn,[o("div",Yn,[i.userPhotoUrl&&!s.isLoading?(u(),h("img",{key:0,class:"h-8 w-8 rounded-full",src:i.userPhotoUrl,alt:"profile",onLoad:e[0]||(e[0]=d=>s.isLoading=!1),onError:e[1]||(e[1]=d=>s.isLoading=!1)},null,40,Kn)):(u(),h("div",Gn,[b(l,{icon:"mdi:user",class:"text-xl"})]))])]),o("figure",null,[i.imageURL?(u(),h("img",{key:0,src:i.imageURL,alt:"recipe",class:"rounded-md"},null,8,Qn)):(u(),h("div",Jn,[b(l,{icon:"emojione-v1:pot-of-food",class:"text-4xl"})]))]),o("div",Zn,[o("h2",eo,f(i.title),1),o("p",to,f(i.descriptions),1),o("p",so,f(i.userName),1)])],8,Wn))),128)),s.loading?(u(),h("div",no,[b(c)])):O("",!0)])):O("",!0)]),o("dialog",oo,[o("div",ro,[o("form",io,[o("button",{onClick:e[2]||(e[2]=(...i)=>s.closeModal&&s.closeModal(...i))},[b(l,{icon:"iconamoon:close-duotone",class:"text-2xl"})])]),o("h3",lo,[ee(f(s.selectedAllRecipe.title)+" ",1),ao]),o("div",null,[o("span",co,f(s.selectedAllRecipe.userName),1)]),o("div",uo,[s.selectedAllRecipe.totalRatings>0?(u(!0),h(N,{key:0},L(s.starArray,(i,d)=>(u(),h("div",{key:d},[b(l,{icon:i==="full"?"ic:round-star":i==="half"?"ic:round-star-half":"ic:outline-star-border",class:"text-xl text-yellow-500"},null,8,["icon"])]))),128)):(u(),h("div",ho,[(u(),h(N,null,L(5,i=>o("div",{key:i.id},[b(l,{icon:"ic:outline-star-border",class:"text-xl"})])),64))])),o("span",po,f(s.selectedAllRecipe.ratingCount),1)]),_o,o("div",fo,[mo,o("p",go,f(s.selectedAllRecipe.descriptions),1)]),bo,o("div",yo,[xo,o("ul",null,[(u(!0),h(N,null,L(s.selectedAllRecipe.allIngredients,(i,d)=>(u(),h("li",{key:i.id,class:"capitalize"},f(d+1)+". "+f(i),1))),128))])]),Ro,o("div",vo,[wo,o("ol",null,[(u(!0),h(N,null,L(s.selectedAllRecipe.allInstructions,(i,d)=>(u(),h("li",{key:i.id},f(d+1)+". "+f(i),1))),128))])]),ko,s.ratingsInText?(u(),h("div",Io,[o("span",To,f(s.ratingsInText),1)])):O("",!0),s.muteRateBnt?(u(),h("div",Ao,Eo)):O("",!0),o("div",Co,[Do,o("div",{class:re([s.muteRateBnt?"border-gray-500/50 text-neutral":"text-yellow-500 border-yellow-500/50","ttext-xl px-1 border py-1 rounded-full flex gap-1"])},[(u(),h(N,null,L(5,i=>o("div",{key:i},[o("button",{disabled:s.muteRateBnt,onClick:d=>s.setRating(i,s.selectedAllRecipe.id),class:"flex justify-center items-center"},[b(l,{icon:s.ratings>=i?"ic:outline-star":"ic:outline-star-border"},null,8,["icon"])],8,No)])),64))],2),o("button",{disabled:s.ratings===0,class:"btn shadow rounded-full",onClick:e[3]||(e[3]=(...i)=>s.sendRatings&&s.sendRatings(...i))},[ee(" Send "),b(l,{icon:"iconamoon:send-fill",class:re(s.ratings===0?"text-gray-500":"text-primary")},null,8,["class"]),s.sendingRatingLoading?(u(),h("span",Lo)):O("",!0)],8,Oo)])])],512)])}const So=te(Bn,[["render",Po]]),$o={components:{Loading:at,Icon:ae},setup(){const t=g(!0),e=g(!1),n=ue(),s=g(n.currentUser),r=xe(),{uid:a}=s.value,l=a,c=g([]),i=g({}),d=Re(r,"recipe"),y=Me(d,je("createdAt","asc"),vt("userId","==",l)),x=Fe(y,p=>{c.value=p.docs.map(m=>({id:m.id,...m.data()})).reverse(),t.value=!1}),R=p=>{const m=p.seconds,D=p.nanoseconds/1e6;return new Date(m*1e3+D)},U=p=>{const m=R(p),D=m.getFullYear().toString().slice(-2),$=m.toLocaleString("default",{month:"short"}),K=m.getUTCDate(),Z=m.getHours()%12||12,se=("0"+m.getMinutes()).slice(-2),W=m.getHours()<12?"am":"pm";return`${K} ${$} ${D} (${Z}:${se} ${W})`};let v=g("");const B=p=>{i.value=p,document.getElementById("my_modal_2").showModal()},A=(p,m)=>{i.value=m,v.value=p},M=()=>{document.getElementById("my_modal_delete").showModal()},S=()=>{console.log("edit recipe",v.value),document.getElementById("my_modal_edit").showModal()},E=async()=>{try{if(e.value=!0,!v.value){console.error("No recipe selected for deletion.");return}const p=be(r,"recipe",v.value),D=(await He(p)).data();if(await wt(p),D&&D.imageURL){const K=lt(),Z=it(K,D.imageURL);await Xs(Z)}document.getElementById("my_modal_delete").close(),console.log("Recipe and associated image deleted successfully:",v.value)}catch(p){console.error("Error deleting recipe and associated image:",p),document.getElementById("my_modal_delete").close(),e.value=!1}finally{e.value=!1}},T=async()=>{try{e.value=!0;const p=be(r,"recipe",v.value);await Ve(p,{...i.value}),document.getElementById("my_modal_edit").close(),console.log("Recipe updated successfully:",v.value)}catch(p){console.error("Error updating recipe:",p),document.getElementById("my_modal_edit").close()}finally{e.value=!1}};return Be(()=>{x()}),{loading:t,isSaveloading:e,recipe:c,formatHour:U,editShowRecipe:A,deleteShowRecipe:M,showRecipeModal:B,selectedRecipe:i,editRecipe:S,deleteRecipe:E,saveEditRecipe:T}}},Bo={class:"py-2"},Mo=o("h1",{class:"font-semibold py-2"},"Your Recipes",-1),jo={class:"flex justify-center sm:justify-start items-center"},Fo={class:"grid grid-cols-3 lg:grid-cols-5 gap-1 sm:gap-3 overflow-hidden py-5 sm:p-2"},Ho=["onClick"],Vo={class:"dropdown absolute top-0 right-0 text-gray-800 shadow"},zo=["onClick"],qo={tabindex:"0",role:"button",class:"btn btn-primary rounded-none btn-xs"},Wo={tabindex:"0",class:"dropdown-content z-[20] menu border border-gray-400/10 p-2 shadow bg-base-100 rounded-md w-32"},Xo=o("p",{class:"text-xs"},"Edit",-1),Yo=o("p",{class:"text-xs"},"Delete",-1),Ko=["src"],Go={key:1,class:"pt-2"},Qo={class:"card-body p-3"},Jo={class:"card-title"},Zo={class:"text-xs truncate"},er={class:"text-[10px] font-medium"},tr={key:1},sr=o("span",{class:"font-semibold text-sm px-4 py-2 bg-blue-300/10 rounded-full shadow"},"You don't have recipe yet.",-1),nr=[sr],or={key:2},rr={id:"my_modal_edit",class:"modal"},ir={class:"modal-box"},lr=o("h3",{class:"font-bold text-4xl"},"Edit Recipe",-1),ar={class:"py-2"},cr=o("label",{class:"block text-sm font-medium text-primary"},"Title",-1),dr={class:"py-2"},ur=o("label",{class:"block text-sm font-medium text-primary"},"Description",-1),hr={class:"py-2"},pr=o("label",{class:"block text-sm font-medium text-primary"},"Ingredients",-1),_r={class:"border border-gray-400/50 p-2 rounded-md"},fr=["onUpdate:modelValue"],mr={class:"py-2"},gr=o("label",{class:"block text-sm font-medium text-primary"},"Instructions",-1),br={class:"border border-gray-400/50 p-2 rounded-md"},yr=["onUpdate:modelValue"],xr={class:"modal-action"},Rr={key:0,class:"loading loading-dots loading-xs"},vr=o("form",{method:"dialog"},[o("button",{class:"btn"},"Close")],-1),wr={id:"my_modal_delete",class:"modal"},kr={class:"modal-box"},Ir=o("h3",{class:"font-bold text-lg"}," Are you sure you want to delete this recipe? ",-1),Tr={class:"modal-action"},Ar={key:0,class:"loading loading-dots loading-xs"},Ur=o("form",{method:"dialog"},[o("button",{class:"btn"},"Close")],-1),Er={id:"my_modal_2",class:"modal",ref:"recipeModal"},Cr={class:"modal-box"},Dr={method:"dialog",class:"absolute top-0 right-0 p-2 z-10"},Nr={class:"font-bold text-4xl capitalize"},Or={class:"py-4"},Lr=o("p",{class:"text-xs text-primary"},"Discriptions:",-1),Pr={class:"capitalize"},Sr=o("hr",{class:"border border-gray-500/10"},null,-1),$r={class:"py-4"},Br=o("p",{class:"text-xs text-primary"},"Ingredients:",-1),Mr=o("hr",{class:"border border-gray-500/10"},null,-1),jr={class:"py-4"},Fr=o("p",{class:"text-xs text-primary"},"Instructions:",-1);function Hr(t,e,n,s,r,a){const l=j("Icon"),c=j("Loading");return u(),h("div",Bo,[Mo,o("div",jo,[o("div",Fo,[s.recipe?(u(!0),h(N,{key:0},L(s.recipe,i=>(u(),h("div",{key:i.id,onClick:d=>s.showRecipeModal(i),class:"card sm:w-52 w-26 bg-base-100 shadow border border-gray-200/10 relative rounded-md"},[o("div",Vo,[o("button",{class:"flex justify-center items-center",onClick:F(d=>s.editShowRecipe(i.id,i),["stop"])},[o("div",qo,[b(l,{icon:"material-symbols-light:settings-outline",class:"text-xl"})])],8,zo),o("ul",Wo,[o("div",{class:"btn flex justify-start text-green-500 mb-1",onClick:e[0]||(e[0]=F(d=>s.editRecipe(t.id),["stop"]))},[b(l,{icon:"material-symbols:edit"}),Xo]),o("div",{class:"btn flex justify-start text-red-500",onClick:e[1]||(e[1]=F(d=>s.deleteShowRecipe(t.id),["stop"]))},[b(l,{icon:"ant-design:delete-twotone"}),Yo])])]),o("figure",null,[i.imageURL?(u(),h("img",{key:0,src:i.imageURL,alt:"recipe",class:""},null,8,Ko)):(u(),h("div",Go,[b(l,{icon:"emojione-v1:pot-of-food",class:"text-4xl"})]))]),o("div",Qo,[o("h2",Jo,f(i.title),1),o("p",Zo,f(i.descriptions),1),o("p",er,f(s.formatHour(i.createdAt)),1)])],8,Ho))),128)):O("",!0),s.recipe.length===0&&!s.loading?(u(),h("div",tr,nr)):O("",!0),s.loading?(u(),h("div",or,[b(c)])):O("",!0)]),o("dialog",rr,[o("div",ir,[lr,o("div",ar,[cr,z(o("input",{type:"text","onUpdate:modelValue":e[2]||(e[2]=i=>s.selectedRecipe.title=i),class:"input input-bordered w-full max-w-xs"},null,512),[[q,s.selectedRecipe.title]])]),o("div",dr,[ur,z(o("textarea",{class:"textarea textarea-bordered w-full","onUpdate:modelValue":e[3]||(e[3]=i=>s.selectedRecipe.descriptions=i)},null,512),[[q,s.selectedRecipe.descriptions]])]),o("div",hr,[pr,o("div",_r,[(u(!0),h(N,null,L(s.selectedRecipe.allIngredients,(i,d)=>(u(),h("div",{key:d,class:"flex items-center space-x-2"},[o("span",null,f(d+1)+".",1),z(o("input",{type:"text","onUpdate:modelValue":y=>s.selectedRecipe.allIngredients[d]=y,class:"input my-1 input-bordered w-full capitalize"},null,8,fr),[[q,s.selectedRecipe.allIngredients[d]]])]))),128))])]),o("div",mr,[gr,o("div",br,[(u(!0),h(N,null,L(s.selectedRecipe.allInstructions,(i,d)=>(u(),h("div",{key:d,class:"flex items-center space-x-2"},[o("span",null,f(d+1)+".",1),z(o("input",{type:"text","onUpdate:modelValue":y=>s.selectedRecipe.allInstructions[d]=y,class:"input my-1 input-bordered w-full capitalize"},null,8,yr),[[q,s.selectedRecipe.allInstructions[d]]])]))),128))])]),o("div",xr,[o("button",{onClick:e[4]||(e[4]=F((...i)=>s.saveEditRecipe&&s.saveEditRecipe(...i),["stop"])),class:"btn text-green-500 w-32"},[ee(" Update "),s.isSaveloading?(u(),h("span",Rr)):O("",!0)]),vr])])]),o("dialog",wr,[o("div",kr,[Ir,o("div",Tr,[o("button",{onClick:e[5]||(e[5]=F((...i)=>s.deleteRecipe&&s.deleteRecipe(...i),["stop"])),class:"btn text-red-500 w-32"},[ee(" Delete "),s.isSaveloading?(u(),h("span",Ar)):O("",!0)]),Ur])])]),o("dialog",Er,[o("div",Cr,[o("form",Dr,[o("button",null,[b(l,{icon:"iconamoon:close-duotone",class:"text-2xl"})])]),o("h3",Nr,f(s.selectedRecipe.title),1),o("div",Or,[Lr,o("p",Pr,f(s.selectedRecipe.descriptions),1)]),Sr,o("div",$r,[Br,o("ul",null,[(u(!0),h(N,null,L(s.selectedRecipe.allIngredients,(i,d)=>(u(),h("li",{key:i.id,class:"capitalize"},f(d+1)+". "+f(i),1))),128))])]),Mr,o("div",jr,[Fr,o("ol",null,[(u(!0),h(N,null,L(s.selectedRecipe.allInstructions,(i,d)=>(u(),h("li",{key:i.id},f(d+1)+". "+f(i),1))),128))])])])],512)])])}const Vr=te($o,[["render",Hr]]),zr={components:{Header:St,Icon:ae,AddRecipe:En,AllRecipe:So,YourRecipe:Vr},setup(){const t=g("");return{search:t,filter:()=>{console.log(t.value)}}}},qr={class:"p-2"},Wr={class:"flex justify-end gap-2 items-center my-2"},Xr=["disabled"];function Yr(t,e,n,s,r,a){const l=j("Header"),c=j("Icon"),i=j("AddRecipe"),d=j("YourRecipe"),y=j("AllRecipe");return u(),h("div",qr,[b(l),o("div",Wr,[z(o("input",{type:"search","onUpdate:modelValue":e[0]||(e[0]=x=>s.search=x),placeholder:"Search...",class:"input input-bordered sm:w-52 md:w-96 w-full"},null,512),[[q,s.search]]),o("button",{disabled:s.search.length===0,class:"btn btn-primary",onClick:e[1]||(e[1]=(...x)=>s.filter&&s.filter(...x))},[b(c,{icon:"bi:search",class:"text-xl"})],8,Xr)]),b(i),b(d),b(y,{searchQuery:s.search},null,8,["searchQuery"])])}const Qr=te(zr,[["render",Yr]]);export{Qr as default};
