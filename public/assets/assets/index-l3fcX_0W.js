const __vite__fileDeps=["assets/home-dPoBCcrx.js","assets/_plugin-vue_export-helper-1rZEJ72k.js","assets/index.esm2017-Cwscf8G8.js","assets/ChatModal-BXURWcDv.js","assets/ChatModal-BsuiRtaR.css","assets/allChefs-BuHQc7ph.js","assets/yourChats-lOQhG1BO.js","assets/login-6POjk0KR.js","assets/crud-DNLDjw-z.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bv="firebase-heartbeat-database",_v=1,tr="firebase-heartbeat-store";let ri=null;function Sf(){return ri||(ri=Ts(bv,_v,{upgrade:(e,t)=>{switch(t){case 0:try{e.createObjectStore(tr)}catch(n){console.warn(n)}}}}).catch(e=>{throw Lt.create("idb-open",{originalErrorMessage:e.message})})),ri}async function vv(e){try{const n=(await Sf()).transaction(tr),r=await n.objectStore(tr).get(Af(e));return await n.done,r}catch(t){if(t instanceof mt)sn.warn(t.message);else{const n=Lt.create("idb-get",{originalErrorMessage:t==null?void 0:t.message});sn.warn(n.message)}}}async function vc(e,t){try{const r=(await Sf()).transaction(tr,"readwrite");await r.objectStore(tr).put(t,Af(e)),await r.done}catch(n){if(n instanceof mt)sn.warn(n.message);else{const r=Lt.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});sn.warn(r.message)}}}function Af(e){return`${e.name}!${e.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function q0(e,t,n){const r=z0(t);(await e.firebaseDependencies.analyticsProvider.get()).logEvent(r,{message_id:n[qf],message_name:n[y0],message_time:n[b0],message_device_time:Math.floor(Date.now()/1e3)})}function z0(e){switch(e){case nr.NOTIFICATION_CLICKED:return"notification_open";case nr.PUSH_RECEIVED:return"notification_foreground";default:throw new Error}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function G0(e,t){const n=t.data;if(!n.isFirebaseMessaging)return;e.onMessageHandler&&n.messageType===nr.PUSH_RECEIVED&&(typeof e.onMessageHandler=="function"?e.onMessageHandler(Oc(n)):e.onMessageHandler.next(Oc(n)));const r=n.data;j0(r)&&r[_0]==="1"&&await q0(e,n.messageType,r)}const Rc="@firebase/messaging",Pc="0.12.9";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pr{constructor(t,n){this.shortDelay=t,this.longDelay=n,ht(n>t,"Short delay should be less than long delay!"),this.isMobile=l_()||d_()}get(){return ow()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
