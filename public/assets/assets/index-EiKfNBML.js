const __vite__fileDeps=["assets/home-BE2AeGCX.js","assets/_plugin-vue_export-helper-DJJixD6Z.js","assets/index.esm2017-IsbBChOf.js","assets/ChatModal-BGB6uzAG.js","assets/ChatModal-BsuiRtaR.css","assets/allChefs-qGQJ_qVE.js","assets/yourChats-DU4vYh5Y.js","assets/login-BS9h4fUh.js","assets/crud-BpDZFlpX.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $b="firebase-heartbeat-database",Vb=1,zn="firebase-heartbeat-store";let Ws=null;function Zu(){return Ws||(Ws=hs($b,Vb,{upgrade:(e,t)=>{switch(t){case 0:try{e.createObjectStore(zn)}catch(n){console.warn(n)}}}}).catch(e=>{throw kt.create("idb-open",{originalErrorMessage:e.message})})),Ws}async function Bb(e){try{const n=(await Zu()).transaction(zn),r=await n.objectStore(zn).get(ef(e));return await n.done,r}catch(t){if(t instanceof dt)Yt.warn(t.message);else{const n=kt.create("idb-get",{originalErrorMessage:t==null?void 0:t.message});Yt.warn(n.message)}}}async function Za(e,t){try{const r=(await Zu()).transaction(zn,"readwrite");await r.objectStore(zn).put(t,ef(e)),await r.done}catch(n){if(n instanceof dt)Yt.warn(n.message);else{const r=kt.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});Yt.warn(r.message)}}}function ef(e){return`${e.name}!${e.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bf="installations",Nv="installations-internal",Mv=e=>{const t=e.getProvider("app").getImmediate(),n=kv(t),r=rr(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},xv=e=>{const t=e.getProvider("app").getImmediate(),n=rr(t,bf).getImmediate();return{getId:()=>Cv(n),getToken:s=>Rv(n,s)}};function Dv(){ct(new Qe(bf,Mv,"PUBLIC")),ct(new Qe(Nv,xv,"PRIVATE"))}Dv();Je(tf,mo);Je(tf,mo,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * the License.
 */var Gn;(function(e){e.PUSH_RECEIVED="push-received",e.NOTIFICATION_CLICKED="notification-clicked"})(Gn||(Gn={}));/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qv="firebase-messaging-database",zv=1,Jn="firebase-messaging-store";let Gs=null;function If(){return Gs||(Gs=hs(qv,zv,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(Jn)}}})),Gs}async function Gv(e){const t=Ef(e),r=await(await If()).transaction(Jn).objectStore(Jn).get(t);if(r)return r;{const s=await Wv(e.appConfig.senderId);if(s)return await vo(e,s),s}}async function vo(e,t){const n=Ef(e),s=(await If()).transaction(Jn,"readwrite");return await s.objectStore(Jn).put(t,n),await s.done,t}function Ef({appConfig:e}){return e.appId}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function m0(e,t){const n=t.data;if(!n.isFirebaseMessaging)return;e.onMessageHandler&&n.messageType===Gn.PUSH_RECEIVED&&(typeof e.onMessageHandler=="function"?e.onMessageHandler(ac(n)):e.onMessageHandler.next(ac(n)));const r=n.data;a0(r)&&r[Vv]==="1"&&await p0(e,n.messageType,r)}const cc="@firebase/messaging",lc="0.12.9";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wr=new Gu("@firebase/auth");function T0(e,...t){Wr.logLevel<=ne.WARN&&Wr.warn(`Auth (${sr}): ${e}`,...t)}function Or(e,...t){Wr.logLevel<=ne.ERROR&&Wr.error(`Auth (${sr}): ${e}`,...t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ir{constructor(t,n){this.shortDelay=t,this.longDelay=n,lt(n>t,"Short delay should be less than long delay!"),this.isMobile=k_()||x_()}get(){return C0()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Yn(e,t,n=!1){if(n)return t;try{return await t}catch(r){throw r instanceof dt&&L0(r)&&e.auth.currentUser===e&&await e.auth.signOut(),r}}function L0({code:e}){return e==="auth/user-disabled"||e==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vf(e,t=[]){let n;switch(e){case"Browser":n=gc(ye());break;case"Worker":n=`${gc(ye())}-${e}`;break;default:n=e}const r=t.length?t.join(","):"FirebaseCore-web";return`${n}/JsCore/${sr}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class or extends ko{constructor(){super(...arguments),this.scopes=[]}addScope(t){return this.scopes.includes(t)||this.scopes.push(t),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class St extends or{constructor(){super("facebook.com")}static credential(t){return Zt._fromParams({providerId:St.PROVIDER_ID,signInMethod:St.FACEBOOK_SIGN_IN_METHOD,accessToken:t})}static credentialFromResult(t){return St.credentialFromTaggedObject(t)}static credentialFromError(t){return St.credentialFromTaggedObject(t.customData||{})}static credentialFromTaggedObject({_tokenResponse:t}){if(!t||!("oauthAccessToken"in t)||!t.oauthAccessToken)return null;try{return St.credential(t.oauthAccessToken)}catch{return null}}}St.FACEBOOK_SIGN_IN_METHOD="facebook.com";St.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function aw(e,t,n=!1){const{auth:r}=e;if(nt(r.app))return Promise.reject(Gt(r));const s="reauthenticate";try{const i=await Yn(e,Wf(r,s,t,e),n);$(i.idToken,r,"internal-error");const o=Co(i.idToken);$(o,r,"internal-error");const{sub:a}=o;return $(e.uid===a,r,"user-mismatch"),_n._forOperation(e,s,i)}catch(i){throw(i==null?void 0:i.code)==="auth/user-not-found"&&Ze(r,"user-mismatch"),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zw=new ir(3e4,6e4);function Ic(){const e=Ye().___jsl;if(e!=null&&e.H){for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let n=0;n<e.CP.length;n++)e.CP[n]=null}}function Gw(e){return new Promise((t,n)=>{var r,s,i;function o(){Ic(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{Ic(),n(je(e,"network-request-failed"))},timeout:zw.get()})}if(!((s=(r=Ye().gapi)===null||r===void 0?void 0:r.iframes)===null||s===void 0)&&s.Iframe)t(gapi.iframes.getContext());else if(!((i=Ye().gapi)===null||i===void 0)&&i.load)o();else{const a=Z0("iframefcb");return Ye()[a]=()=>{gapi.load?o():n(je(e,"network-request-failed"))},X0(`${Q0()}?onload=${a}`).catch(c=>n(c))}}).catch(t=>{throw Pr=null,t})}let Pr=null;function Jw(e){return Pr=Pr||Gw(e),Pr}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yw=new ir(5e3,15e3),Xw="__/auth/iframe",Qw="emulator/auth/iframe",Zw={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},eI=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function tI(e){const t=e.config;$(t.authDomain,e,"auth-domain-config-required");const n=t.emulator?Ao(t,Qw):`https://${e.config.authDomain}/${Xw}`,r={apiKey:t.apiKey,appName:e.name,v:sr},s=eI.get(e.config.apiHost);s&&(r.eid=s);const i=e._getFrameworks();return i.length&&(r.fw=i.join(",")),`${n}?${nr(r).slice(1)}`}async function nI(e){const t=await Jw(e),n=Ye().gapi;return $(n,e,"internal-error"),t.open({where:document.body,url:tI(e),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:Zw,dontclear:!0},r=>new Promise(async(s,i)=>{await r.restyle({setHideOnLeave:!1});const o=je(e,"network-request-failed"),a=Ye().setTimeout(()=>{i(o)},Yw.get());function c(){Ye().clearTimeout(a),s(r)}r.ping(c).then(c,()=>{i(o)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const uI="__/auth/handler",fI="emulator/auth/handler",dI=encodeURIComponent("fac");async function Sc(e,t,n,r,s,i){$(e.config.authDomain,e,"auth-domain-config-required"),$(e.config.apiKey,e,"invalid-api-key");const o={apiKey:e.config.apiKey,appName:e.name,authType:n,redirectUrl:r,v:sr,eventId:s};if(t instanceof ko){t.setDefaultLanguage(e.languageCode),o.providerId=t.providerId||"",$_(t.getCustomParameters())||(o.customParameters=JSON.stringify(t.getCustomParameters()));for(const[l,f]of Object.entries({}))o[l]=f}if(t instanceof or){const l=t.getScopes().filter(f=>f!=="");l.length>0&&(o.scopes=l.join(","))}e.tenantId&&(o.tid=e.tenantId);const a=o;for(const l of Object.keys(a))a[l]===void 0&&delete a[l];const c=await e._getAppCheckToken(),u=c?`#${dI}=${encodeURIComponent(c)}`:"";return`${hI(e)}?${nr(a).slice(1)}${u}`}function hI({config:e}){return e.emulator?Ao(e,fI):`https://${e.authDomain}/${uI}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
