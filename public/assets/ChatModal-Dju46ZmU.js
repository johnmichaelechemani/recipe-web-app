import{_ as At,C as Lt,z as Xe,A as ve,B as Ot,D as Nt,E as Pt,S as Mt,G as jt,H as Bt,g as dt,r as h,q as Ge,I as Pe,p as Ye,J as Ft,K as ht,o as b,c as y,a as i,j as I,n as se,t as P,e as le,d as qt,b as w,x as ie,u as l,T as ae,F as Be,w as Me,f as fe,i as Ht,h as Je,y as zt}from"./index-CiQRl2SD.js";import{u as Vt,I as J}from"./firebase-CNX3zOOw.js";import{s as Wt,d as Ze,h as Qe,a as Kt,c as et,b as tt,q as Xt,o as Gt}from"./index.esm2017-oYPZ13-5.js";/**
 * @license
 ...
 */const ft="firebasestorage.googleapis.com",gt="storageBucket",Yt=2*60*1e3,Jt=10*60*1e3;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
${this.customData.serverResponse}`:this.message=this._baseMessage}}var A;(function(e){e.UNKNOWN="unknown",e.OBJECT_NOT_FOUND="object-not-found",e.BUCKET_NOT_FOUND="bucket-not-found",e.PROJECT_NOT_FOUND="project-not-found",e.QUOTA_EXCEEDED="quota-exceeded",e.UNAUTHENTICATED="unauthenticated",e.UNAUTHORIZED="unauthorized",e.UNAUTHORIZED_APP="unauthorized-app",e.RETRY_LIMIT_EXCEEDED="retry-limit-exceeded",e.INVALID_CHECKSUM="invalid-checksum",e.CANCELED="canceled",e.INVALID_EVENT_NAME="invalid-event-name",e.INVALID_URL="invalid-url",e.INVALID_DEFAULT_BUCKET="invalid-default-bucket",e.NO_DEFAULT_BUCKET="no-default-bucket",e.CANNOT_SLICE_BLOB="cannot-slice-blob",e.SERVER_FILE_WRONG_SIZE="server-file-wrong-size",e.NO_DOWNLOAD_URL="no-download-url",e.INVALID_ARGUMENT="invalid-argument",e.INVALID_ARGUMENT_COUNT="invalid-argument-count",e.APP_DELETED="app-deleted",e.INVALID_ROOT_OPERATION="invalid-root-operation",e.INVALID_FORMAT="invalid-format",e.INTERNAL_ERROR="internal-error",e.UNSUPPORTED_ENVIRONMENT="unsupported-environment"})(A||(A={}));function Ce(e){return"storage/"+e}function Fe(){const e="An unknown error occurred, please check the error payload for server response.";return new L(A.UNKNOWN,e)}function Zt(e){return new L(A.OBJECT_NOT_FOUND,"Object '"+e+"' does not exist.")}function Qt(e){return new L(A.QUOTA_EXCEEDED,"Quota for bucket '"+e+"' exceeded, please view quota on https://firebase.google.com/pricing/.")}function es(){const e="User is not authenticated, please authenticate using Firebase Authentication and try again.";return new L(A.UNAUTHENTICATED,e)}function ts(){return new L(A.UNAUTHORIZED_APP,"This app does not have permission to access Firebase Storage on this project.")}function ss(e){return new L(A.UNAUTHORIZED,"User does not have permission to access '"+e+"'.")}function ns(){return new L(A.RETRY_LIMIT_EXCEEDED,"Max retry time for operation exceeded, please try again.")}function rs(){return new L(A.CANCELED,"User canceled the upload/download.")}function os(e){return new L(A.INVALID_URL,"Invalid URL '"+e+"'.")}function is(e){return new L(A.INVALID_DEFAULT_BUCKET,"Invalid default bucket '"+e+"'.")}function as(){return new L(A.NO_DEFAULT_BUCKET,"No default bucket found. Did you set the '"+gt+"' property when initializing the app?")}function ls(){return new L(A.CANNOT_SLICE_BLOB,"Cannot slice blob for upload. Please retry the upload.")}function us(){return new L(A.NO_DOWNLOAD_URL,"The given file does not have any download URLs.")}function cs(e){return new L(A.UNSUPPORTED_ENVIRONMENT,`${e} is missing. Make sure to install the required polyfills. See https://firebase.google.com/docs/web/environments-js-sdk#polyfills for more information.`)}function je(e){return new L(A.INVALID_ARGUMENT,e)}function mt(){return new L(A.APP_DELETED,"The Firebase app was deleted.")}function ds(e){return new L(A.INVALID_ROOT_OPERATION,"The operation '"+e+"' cannot be performed on a root reference, create a non-root reference using child, such as .child('file.png').")}function pe(e,t){return new L(A.INVALID_FORMAT,"String does not match format '"+e+"': "+t)}function ge(e){throw new L(A.INTERNAL_ERROR,"Internal error: "+e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fs(e,t,s){let n=1,r=null,o=null,a=!1,c=0;function d(){return c===2}let u=!1;function v(...m){u||(u=!0,t.apply(null,m))}function x(m){r=setTimeout(()=>{r=null,e(p,d())},m)}function f(){o&&clearTimeout(o)}function p(m,..._){if(u){f();return}if(m){f(),v.call(null,m,..._);return}if(d()||a){f(),v.call(null,m,..._);return}n<64&&(n*=2);let C;c===1?(c=2,C=0):C=(n+Math.random())*1e3,x(C)}let T=!1;function U(m){T||(T=!0,f(),!u&&(r!==null?(m||(c=2),clearTimeout(r),x(0)):m||(c=1)))}return x(0),o=setTimeout(()=>{a=!0,U(!0)},s),U}function gs(e){e(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bs{constructor(t,s,n,r,o,a,c,d,u,v,x,f=!0){this.url_=t,this.method_=s,this.headers_=n,this.body_=r,this.successCodes_=o,this.additionalRetryCodes_=a,this.callback_=c,this.errorCallback_=d,this.timeout_=u,this.progressCallback_=v,this.connectionFactory_=x,this.retry=f,this.pendingConnection_=null,this.backoffId_=null,this.canceled_=!1,this.appDelete_=!1,this.promise_=new Promise((p,T)=>{this.resolve_=p,this.reject_=T,this.start_()})}start_(){const t=(n,r)=>{if(r){n(!1,new ye(!1,null,!0));return}const o=this.connectionFactory_();this.pendingConnection_=o;const a=c=>{const d=c.loaded,u=c.lengthComputable?c.total:-1;this.progressCallback_!==null&&this.progressCallback_(d,u)};this.progressCallback_!==null&&o.addUploadProgressListener(a),o.send(this.url_,this.method_,this.body_,this.headers_).then(()=>{this.progressCallback_!==null&&o.removeUploadProgressListener(a),this.pendingConnection_=null;const c=o.getErrorCode()===ue.NO_ERROR,d=o.getStatus();if(!c||vs(d,this.additionalRetryCodes_)&&this.retry){const v=o.getErrorCode()===ue.ABORT;n(!1,new ye(!1,null,v));return}const u=this.successCodes_.indexOf(d)!==-1;n(!0,new ye(u,o))})},s=(n,r)=>{const o=this.resolve_,a=this.reject_,c=r.connection;if(r.wasSuccessCode)try{const d=this.callback_(c,c.getResponse());ms(d)?o(d):o()}catch(d){a(d)}else if(c!==null){const d=Fe();d.serverResponse=c.getErrorText(),this.errorCallback_?a(this.errorCallback_(c,d)):a(d)}else if(r.canceled){const d=this.appDelete_?mt():rs();a(d)}else{const d=ns();a(d)}};this.canceled_?s(!1,new ye(!1,null,!0)):this.backoffId_=fs(t,s,this.timeout_)}getPromise(){return this.promise_}cancel(t){this.canceled_=!0,this.appDelete_=t||!1,this.backoffId_!==null&&gs(this.backoffId_),this.pendingConnection_!==null&&this.pendingConnection_.abort()}}class ye{constructor(t,s,n){this.wasSuccessCode=t,this.connection=s,this.canceled=!!n}}function ys(e,t){t!==null&&t.length>0&&(e.Authorization="Firebase "+t)}function xs(e,t){e["X-Firebase-Storage-Version"]="webjs/"+(t??"AppManager")}function ws(e,t){t&&(e["X-Firebase-GMPID"]=t)}function _s(e,t){t!==null&&(e["X-Firebase-AppCheck"]=t)}function ks(e,t,s,n,r,o,a=!0){const c=pt(e.urlParams),d=e.url+c,u=Object.assign({},e.headers);return ws(u,t),ys(u,s),xs(u,o),_s(u,n),new bs(d,e.method,u,e.body,e.successCodes,e.additionalRetryCodes,e.handler,e.errorHandler,e.timeout,e.progressCallback,r,a)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rs(){return typeof BlobBuilder<"u"?BlobBuilder:typeof WebKitBlobBuilder<"u"?WebKitBlobBuilder:void 0}function Is(...e){const t=Rs();if(t!==void 0){const s=new t;for(let n=0;n<e.length;n++)s.append(e[n]);return s.getBlob()}else{if(He())return new Blob(e);throw new L(A.UNSUPPORTED_ENVIRONMENT,"This browser doesn't seem to support creating Blobs")}}function Ts(e,t,s){return e.webkitSlice?e.webkitSlice(t,s):e.mozSlice?e.mozSlice(t,s):e.slice?e.slice(t,s):null}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Us(e){if(typeof atob>"u")throw cs("base-64");return atob(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const X={RAW:"raw",BASE64:"base64",BASE64URL:"base64url",DATA_URL:"data_url"};class Ee{constructor(t,s){this.data=t,this.contentType=s||null}}function Cs(e,t){switch(e){case X.RAW:return new Ee(vt(t));case X.BASE64:case X.BASE64URL:return new Ee(bt(e,t));case X.DATA_URL:return new Ee($s(t),Ss(t))}throw Fe()}function vt(e){const t=[];for(let s=0;s<e.length;s++){let n=e.charCodeAt(s);if(n<=127)t.push(n);else if(n<=2047)t.push(192|n>>6,128|n&63);else if((n&64512)===55296)if(!(s<e.length-1&&(e.charCodeAt(s+1)&64512)===56320))t.push(239,191,189);else{const o=n,a=e.charCodeAt(++s);n=65536|(o&1023)<<10|a&1023,t.push(240|n>>18,128|n>>12&63,128|n>>6&63,128|n&63)}else(n&64512)===56320?t.push(239,191,189):t.push(224|n>>12,128|n>>6&63,128|n&63)}return new Uint8Array(t)}function Es(e){let t;try{t=decodeURIComponent(e)}catch{throw pe(X.DATA_URL,"Malformed data URL.")}return vt(t)}function bt(e,t){switch(e){case X.BASE64:{const r=t.indexOf("-")!==-1,o=t.indexOf("_")!==-1;if(r||o)throw pe(e,"Invalid character '"+(r?"-":"_")+"' found: is it base64url encoded?");break}case X.BASE64URL:{const r=t.indexOf("+")!==-1,o=t.indexOf("/")!==-1;if(r||o)throw pe(e,"Invalid character '"+(r?"+":"/")+"' found: is it base64 encoded?");t=t.replace(/-/g,"+").replace(/_/g,"/");break}}let s;try{s=Us(t)}catch(r){throw r.message.includes("polyfill")?r:pe(e,"Invalid character found")}const n=new Uint8Array(s.length);for(let r=0;r<s.length;r++)n[r]=s.charCodeAt(r);return n}class yt{constructor(t){this.base64=!1,this.contentType=null;const s=t.match(/^data:([^,]+)?,/);if(s===null)throw pe(X.DATA_URL,"Must be formatted 'data:[<mediatype>][;base64],<data>");const n=s[1]||null;n!=null&&(this.base64=Ds(n,";base64"),this.contentType=this.base64?n.substring(0,n.length-7):n),this.rest=t.substring(t.indexOf(",")+1)}}function $s(e){const t=new yt(e);return t.base64?bt(X.BASE64,t.rest):Es(t.rest)}function Ss(e){return new yt(e).contentType}function Ds(e,t){return e.length>=t.length?e.substring(e.length-t.length)===t:!1}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xt(e){let t;try{t=JSON.parse(e)}catch{return null}return ps(t)?t:null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function As(e){if(e.length===0)return null;const t=e.lastIndexOf("/");return t===-1?"":e.slice(0,t)}function Ls(e,t){const s=t.split("/").filter(n=>n.length>0).join("/");return e.length===0?s:e+"/"+s}function wt(e){const t=e.lastIndexOf("/",e.length-2);return t===-1?e:e.slice(t+1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Os(e,t){return t}class j{constructor(t,s,n,r){this.server=t,this.local=s||t,this.writable=!!n,this.xform=r||Os}}let xe=null;function Ns(e){return!qe(e)||e.length<2?e:wt(e)}function _t(){if(xe)return xe;const e=[];e.push(new j("bucket")),e.push(new j("generation")),e.push(new j("metageneration")),e.push(new j("name","fullPath",!0));function t(o,a){return Ns(a)}const s=new j("name");s.xform=t,e.push(s);function n(o,a){return a!==void 0?Number(a):a}const r=new j("size");return r.xform=n,e.push(r),e.push(new j("timeCreated")),e.push(new j("updated")),e.push(new j("md5Hash",null,!0)),e.push(new j("cacheControl",null,!0)),e.push(new j("contentDisposition",null,!0)),e.push(new j("contentEncoding",null,!0)),e.push(new j("contentLanguage",null,!0)),e.push(new j("contentType",null,!0)),e.push(new j("metadata","customMetadata",!0)),xe=e,xe}function Ps(e,t){function s(){const n=e.bucket,r=e.fullPath,o=new z(n,r);return t._makeStorageReference(o)}Object.defineProperty(e,"ref",{get:s})}function Ms(e,t,s){const n={};n.type="file";const r=s.length;for(let o=0;o<r;o++){const a=s[o];n[a.local]=a.xform(n,t[a.server])}return Ps(n,e),n}function kt(e,t,s){const n=xt(t);return n===null?null:Ms(e,n,s)}function js(e,t,s,n){const r=xt(t);if(r===null||!qe(r.downloadTokens))return null;const o=r.downloadTokens;if(o.length===0)return null;const a=encodeURIComponent;return o.split(",").map(u=>{const v=e.bucket,x=e.fullPath,f="/b/"+a(v)+"/o/"+a(x),p=ke(f,s,n),T=pt({alt:"media",token:u});return p+T})[0]}function Bs(e,t){const s={},n=t.length;for(let r=0;r<n;r++){const o=t[r];o.writable&&(s[o.server]=e[o.local])}return JSON.stringify(s)}class ze{constructor(t,s,n,r){this.url=t,this.method=s,this.handler=n,this.timeout=r,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rt(e){if(!e)throw Fe()}function Fs(e,t){function s(n,r){const o=kt(e,r,t);return Rt(o!==null),o}return s}function qs(e,t){function s(n,r){const o=kt(e,r,t);return Rt(o!==null),js(o,r,e.host,e._protocol)}return s}function It(e){function t(s,n){let r;return s.getStatus()===401?s.getErrorText().includes("Firebase App Check token is invalid")?r=ts():r=es():s.getStatus()===402?r=Qt(e.bucket):s.getStatus()===403?r=ss(e.path):r=n,r.status=s.getStatus(),r.serverResponse=n.serverResponse,r}return t}function Tt(e){const t=It(e);function s(n,r){let o=t(n,r);return n.getStatus()===404&&(o=Zt(e.path)),o.serverResponse=r.serverResponse,o}return s}function Hs(e,t,s){const n=t.fullServerUrl(),r=ke(n,e.host,e._protocol),o="GET",a=e.maxOperationRetryTime,c=new ze(r,o,qs(e,s),a);return c.errorHandler=Tt(t),c}function zs(e,t){const s=t.fullServerUrl(),n=ke(s,e.host,e._protocol),r="DELETE",o=e.maxOperationRetryTime;function a(d,u){}const c=new ze(n,r,a,o);return c.successCodes=[200,204],c.errorHandler=Tt(t),c}function Vs(e,t){return e&&e.contentType||t&&t.type()||"application/octet-stream"}function Ws(e,t,s){const n=Object.assign({},s);return n.fullPath=e.path,n.size=t.size(),n.contentType||(n.contentType=Vs(null,t)),n}function Ks(e,t,s,n,r){const o=t.bucketOnlyServerUrl(),a={"X-Goog-Upload-Protocol":"multipart"};function c(){let C="";for(let $=0;$<2;$++)C=C+Math.random().toString().slice(2);return C}const d=c();a["Content-Type"]="multipart/related; boundary="+d;const u=Ws(t,n,r),v=Bs(u,s),x="--"+d+`\r
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ce{constructor(t,s){this._service=t,s instanceof z?this._location=s:this._location=z.makeFromUrl(s,t.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(t,s){return new ce(t,s)}get root(){const t=new z(this._location.bucket,"");return this._newRef(this._service,t)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return wt(this._location.path)}get storage(){return this._service}get parent(){const t=As(this._location.path);if(t===null)return null;const s=new z(this._location.bucket,t);return new ce(this._service,s)}_throwIfRoot(t){if(this._location.path==="")throw ds(t)}}function Ys(e,t,s){e._throwIfRoot("uploadBytes");const n=Ks(e.storage,e._location,_t(),new te(t,!0),s);return e.storage.makeRequestWithTokens(n,Ve).then(r=>({metadata:r,ref:e}))}function Js(e){e._throwIfRoot("getDownloadURL");const t=Hs(e.storage,e._location,_t());return e.storage.makeRequestWithTokens(t,Ve).then(s=>{if(s===null)throw us();return s})}function Zs(e){e._throwIfRoot("deleteObject");const t=zs(e.storage,e._location);return e.storage.makeRequestWithTokens(t,Ve)}function Qs(e,t){const s=Ls(e._location.path,t),n=new z(e._location.bucket,s);return new ce(e.storage,n)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
