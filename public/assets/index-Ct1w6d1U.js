const __vite__fileDeps=["assets/home-DLbYu-cT.js","assets/_plugin-vue_export-helper-CxIX16Ho.js","assets/login-D3a-hKg3.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mh(t){wn(new Yt("platform-logger",e=>new Kd(e),"PRIVATE")),wn(new Yt("heartbeat",e=>new Oh(e),"PRIVATE")),Vt(us,Yi,t),Vt(us,Yi,"esm2017"),Vt("fire-js","")}Mh("");var Dh="firebase",Lh="10.12.2";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bc(){return typeof Fe().WorkerGlobalScope<"u"&&typeof Fe().importScripts=="function"}async function Mp(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function Dp(){var t;return((t=navigator==null?void 0:navigator.serviceWorker)===null||t===void 0?void 0:t.controller)||null}function Lp(){return bc()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
